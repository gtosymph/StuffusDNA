...
/** Couleurs successives attribuees aux fils. */
...
export const couleurFil = (index) => COULEURS[index % COULEURS.length];
...
export function dessinerEvolution(canvas, series, contexte = {}) {
  ...
  traces.forEach((serie, index) => {
    const couleur = couleurFil(index);
    ...
    if (estMeilleur && points.length > 1) {
      ...
      fond.addColorStop(0, 'rgba(124, 108, 246, 0.22)');
      fond.addColorStop(1, 'rgba(124, 108, 246, 0)');
      ctx.fillStyle = fond;
      ctx.beginPath();
